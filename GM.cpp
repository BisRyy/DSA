...
void userlist()
{
    ...
    {
        cout << "\n\n\t\t" << name << "\t\t" << username << "\t\t" << password << "\t\t" << address << "\t\t" << phone << "\t\t" << email << endl;
    }
    file.close();
}
void sellerlist()
...
void accountsetting(int user)
{
        ...
        if (user == 1)
    {
        ...
        while (file >> bn >> be >> ba >> bp >> bu >> pw)
        {
            if (bu == currentuser.username)
            {
                ...
                cout << "\n\n\t\t" << setw(20) << left << "name" << setw(30) << left << "email" << setw(30) << left << "address" << setw(20) << left << "phonenumber" << setw(20) << left << "username" << setw(20) << left << "password" << endl;
                cout << "\t\t" << setw(20) << left << bn << setw(30) << left << be << setw(30) << left << ba << setw(20) << left << bp << setw(20) << left << bu << setw(20) << left << securePassword(pw);
                break;
            }
        }
        file.close();
    ...
    if (user == 2)
    {
        ...
        while (file >> mn >> me >> ma >> mp >> pw)
        {
            ...
            {
                cout << "\n\n\t\tHere is your info" << endl;
                cout << "\n\n\t\t" << setw(20) << left << "MillinHouseName" << setw(30) << left << "email" << setw(30) << left << "address" << setw(20) << left << "phonenumber" << setw(20) << left << "password" << endl;
                cout << "\t\t" << setw(20) << left << mn << setw(30) << left << me << setw(30) << left << ma << setw(20) << left << mp << setw(20) << left << securePassword(pw);
                break;
            }
        }
        file.close();
...
void changesetting(int user)
{
    if (user == 1)
    {
        ...
        while (file >> bn1 >> be1 >> ba1 >> bp1 >> bu1 >> pw1)
        {
            ...
            write << "\n"
                  << setw(20) << left << bn1 << setw(30) << left << be1 << setw(30) << left << ba1 << setw(20) << left << bp1 << setw(20) << left << bu1 << setw(20) << left << securePassword(pw1);
        }
        write.close();
        file.close();
    ...
    if (user == 2)
    {
        ...
        while (file >> mn1 >> me1 >> ma1 >> mp1 >> pw1)
        {
            ...
            write << "\n"
                  << setw(20) << left << mn1 << setw(30) << left << me1 << setw(30) << left << ma1 << setw(20) << left << mp1 << setw(20) << left << securePassword(pw1);
        }
        write.close();
        file.close();
...
void deleteaccount(int user)
{
    if (user == 1)
    {
        ...
        while (file >> bn >> be >> ba >> bp >> bu >> pw)
        {
            ...
            write << "\n"
                  << setw(20) << left << bn << setw(30) << left << be << setw(30) << left << ba << setw(20) << left << bp << setw(20) << left << bu << setw(20) << left << securePassword(pw);
        }
        write.close();
        file.close();
        remove("buyerinfo.txt");
    ...
    if (user == 2)
    {
        ...
        while (file >> mn >> me >> ma >> mp >> pw)
        {
            ...
            write << "\n"
                  << setw(20) << left << mn << setw(30) << left << me << setw(30) << left << ma << setw(20) << left << mp << setw(20) << left << securePassword(pw);
        }
        write.close();
        file.close();
        remove("sellerinfo.txt");
...
void login(int user)
{
...

    {
        if (loginbuyer())
            ...
            cout << "\n\n\t\tCheck your informationa and try again." << endl;
            cont();
    }
    if (user == 2)
    {
        ...
        if (loginseller())
            ...
            cout << "\n\n\t\tcheck you information and try agian." << endl;
            cont();
    }
}
...
void buyersignup()
{
   ...
   getline(cin, currentuser.username);
    ...
    file << "\n"
         << setw(20) << left << currentuser.name << setw(30) << left << currentuser.email << setw(30) << left << currentuser.address << setw(20) << left << currentuser.phonenumber << setw(20) << left << currentuser.username << setw(20) << left << securePassword(currentuser.password);
    file.close();
}
...
void sellersignup()
{
    ...
    file << "\n"
         << setw(20) << left << miller.name << setw(30) << left << miller.email << setw(30) << left << miller.address << setw(20) << left << miller.phonenumber << setw(20) << left << securePassword(miller.password);
    file.close();
}
bool loginseller()
{
...
void addlisting()
{
    ...
    if (!check(productname))
    {
        ...
        file << setw(20) << left << productname << setw(20) << left << productprice << setw(10) << left << millingprice << setw(10) << left << Amount << setw(10) << left << miller.name << "\n";
        file.close();
        Product *p = new Product();
...
void updateproduct()
{
    ...
    if (check(pn))
    {
        ...
        while (file >> pn1 >> pp1 >> mp1 >> am1 >> mn1)
        {
            ...
            {
                write << setw(20) << left << pn << setw(20) << left << pp << setw(10) << left << mp << setw(10) << left << am << setw(20) << left << mn1 << endl;
            }
            else
            {
                write << setw(20) << left << pn1 << setw(20) << left << pp1 << setw(10) << left << mp1 << setw(10) << left << am1 << setw(20) << left << mn1 << endl;
            }
        }
        write.close();
        file.close();
...
void productlist()
{
    ...
    while (option != 4)
    {
        ...
        Product *temp = head;
        cout << "\n\n\t\t              Products              " << endl;
        cout << setw(20) << left << "\n\n\t\tproductName" << setw(20) << left << "productPrice" << setw(20) << left << "MillingPrice" << setw(10) << left << "Amount" << setw(20) << left << "MillingHouse" << endl;
        while (temp != NULL)
        {
            cout << "\t\t" << setw(20) << left << temp->ProductName << setw(20) << left << temp->ProductPrice << setw(20) << left << temp->MillingPrice << setw(10) << left << temp->amount << setw(20) << left << temp->millinghousename << endl;
            temp = temp->next;
        }
...
void productformillers()
{
    ...
    while (temp != NULL)
    {
        ...
        {
            cout << setw(20) << left << "\n\n\t\tproductName" << setw(20) << left << "productPrice" << setw(20) << left << "MillingPrice" << setw(10) << left << "Amount" << endl;
            cout << "\t\t" << setw(20) << left << temp->ProductName << setw(20) << left << temp->ProductPrice << setw(20) << left << temp->MillingPrice << setw(10) << left << temp->amount << endl;
        }
        temp = temp->next;
    }
    cont();
    ...
    if (checkp(p, mn))
    {
        ...
        if (checka(p, mn, a))
        {
            ...
            while (file >> pn >> pp >> mp >> am >> mhn)
            {
                ...
                {
                    am = am - a;
                    file2 << setw(20) << left << pn << setw(20) << left << pp << setw(10) << left << mp << setw(10) << left << a << setw(20) << left << mhn << setw(20) << left << currentuser.username << setw(20) << left << "pending..." << endl;
                    if (am == 0)
                    {
                        deletefromnode(p, mn);
                        continue;
                ...
                file1 << setw(20) << left << pn << setw(20) << left << pp << setw(10) << left << mp << setw(10) << left << am << setw(20) << left << mhn << endl;
            }
...
void orders(int x)
{
    if (x == 1)
    {
        ...
        if (checkinorder(1))
        {
            ...
            cout << "\n\n\t\t" << setw(20) << left << "ProductName" << setw(20) << left << "ProductPrice" << setw(20) << left << "MillingPrice" << setw(10) << left << "amount" << setw(20) << left << "From" << setw(20) << left << "Status"<<endl;
            while (file >> n >> p >> m >> a >> mhn >> un >> st)
            {
                if (un == currentuser.username)
                {
                    cout << "\t\t" << setw(20) << left << n << setw(20) << left << p << setw(20) << left << m << setw(10) << left << a << setw(20) << left << mhn << setw(20) << left << st<<endl;
                }
            }
    ...
    else
    {
        ...
        if (checkinorder(2))
        {
            ...
            while (option != 3)
            {
                ...
                file.open("order.txt", ios::in);
                cout << "\n\n\t\t         These are your orders       " << endl;
                cout << "\t\t" << setw(20) << left << "ProductName" << setw(10) << left << "amount" << setw(20) << left << "Ordered by";
                while (file >> n >> p >> m >> a >> mhn >> un >> st)
                {
                ...
                else if (x == 2)
                {
                    ...
                    if (checkup(un, p))
                    {
                        ...
                        while (file >> pn >> pp >> mp >> am >> mhn >> usn >> st)
                        {
                            ...
                            file1 << setw(20) << left << pn << setw(20) << left << pp << setw(10) << left << mp << setw(10) << left << am << setw(20) << left << mhn << setw(20) << left << usn << setw(20) << left << st << endl;
                        }
                        file.close();
                        file1.close();
                        remove("order.txt");
...
void search()
{
    ...
    while (temp != NULL)
    {
        if (temp->ProductName == value)
        {
            ...
            cout << "\t\t" << setw(20) << left << "productName" << setw(20) << left << "productPrice" << setw(20) << left << "MillingPrice" << setw(10) << left << "amount" << setw(20) << left << "Millinhouse" << endl;
            cout << "\t\t" << setw(20) << left << temp->ProductName << setw(20) << left << temp->ProductPrice << setw(20) << left << temp->MillingPrice << setw(10) << left << temp->amount << setw(20) << left << temp->millinghousename << endl;
            cont();
            break;
        }
